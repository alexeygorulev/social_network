...
const UploadPopup = (props) => {
  const { handle, handleUpload, origimgFile, avatarId, toggleUpload, isVideo, origVideoFile } = props;
            ...
            <div className="popup-photo__container">
              {!isVideo ? (
                ...
                <div className="video__upload">
                  {origVideoFile && <video src={origVideoFile}></video>}
                </div>
              )}
            </div>
